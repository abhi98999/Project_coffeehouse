...
.register h1 { color: brown; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; }
...
<body>
  <div class="register">
	<h1>REGISTER!!</h1>
    <fm:form action="${pageContext.request.contextPath}/registerUser" method="post" >
...
<tr>
<td><font color="red"> <fm:errors path="userName"></fm:errors></font></td>
</tr>
