...
<%@page isELIgnored="false" %>
  ...
  <div class="row">
   <div class="col-md-5">
    <img src="resources/images/${product.productId}.jpg" class="image-responsive" height="300" width="300" border="1"/>
...
<div class="row add-to-cart">
 ...
 <div class="col-md-9">
  ...
  -->   <a href="${request.getContextPath()}/coffeehouse/order/${product.productId}" role="button" name="_eventId_submit" 
